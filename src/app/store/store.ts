...
import { friendApi } from '../store/slices/friendApi';
import { postApi } from '../store/slices/postApi';

import  authReducer  from "../store/state/authSlice";
import  userReducer  from "../store/state/userSlice";
import  modelReducer from "../store/state/modelSlice";
