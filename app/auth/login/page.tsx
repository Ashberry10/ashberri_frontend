    ...
    <body
      ...
      <div className="px-7 py-4 shadow bg-white rounded-md flex flex-col gap-2">
        ...
        <button onClick={onSubmit}>Login</button>
          ...
          <button className="bg-green-600 hover:bg-green-700 text-white my-2 py-3 px-4 mx-auto rounded-md font-bold w-fit" type="button" onClick={() => router.push("/auth/signup")}>Create New Account</button>
