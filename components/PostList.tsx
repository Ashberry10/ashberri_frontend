...
import { useGetAllPostQuery } from '../pages/api/postApi';
import { useGetAllUserIdQuery } from '../pages/api/authApi';
...
function PostList() {
  ...
  // const {getAllUserId} = useGetAllUserIdQuery();
